...
// 7. Static Expenses Report (Fixed Query Parameter Bug)
exports.getExpensesReport = async (req, res) => {
    try {
        ...
        if (sDate && eDate) {
            ...
            queryParams = [cleanUserId, EXPENSE_SEARCH_IDS, sDate, eDate]; // FIXED: queryParams typo
        }
